...
NS_LOG_COMPONENT_DEFINE ("FTP-SINGLE");
...
int main (int argc,char *argv[])
{
  ...
  */
  ...
  mobility.SetPositionAllocator (positionAlloc);
	...
	ApplicationContainer senderapp1 = sender1.Install(rtNodes.Get(1));
