...
int main (int argc,char *argv[])
{
  ...
  */
	...
	mobility.Install(rtNodes);
	
	InternetStackHelper stack;
	stack.Install(rtNodes);
	...
	sw2svInterface = address.Assign (switch2server);
	...
	Address remoteAddress2 = InetSocketAddress(wifiInterfaces.GetAddress(1),2000);
	...
	sender2.SetConstantRate(DataRate("1Mb/s"), 1024);
	...
	ApplicationContainer senderapp = sender1.Install(rtNodes.Get(1));
	senderapp.Add(sender2.Install(rtNodes.Get(1)));
